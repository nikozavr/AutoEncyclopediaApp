 ...
 */
public class ListGenersAdapter extends ArrayAdapter<Generation> {
    private Context context;
    private int layoutResourceId;
    private ArrayList<Generation> data = new ArrayList<Generation>();

    public ListGenersAdapter(Context context, int layoutResourceId,
                            ArrayList<Generation> data) {
